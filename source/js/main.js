...
$(document).ready(function() {
    ...
    function init() {
        ...
        controls.lookSpeed = 0.010;
        controls.autoForward = true;

        scene = new THREE.Scene();
        scene.fog = new THREE.FogExp2(0x868E8E, 0.00030);
        ...
        renderer.setClearColor( 0x868E8E );
    ...
    function generateTexture(data, width, height) {
        ...
        for ( var i = 0, j = 0, l = imageData.length; i < l; i += 4, j ++ ) {
            ...
            vector3.normalize();
            imageData[ i ] = 67 * ( 0.5 + data[ j ] * 0.007 );
            imageData[ i + 1 ] = 75 * ( 0.5 + data[ j ] * 0.007 );
